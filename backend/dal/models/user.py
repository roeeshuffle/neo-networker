...
class User(db.Model):
    ...
    # user_preferences = db.Column(db.JSON, nullable=True)  # Temporarily disabled - column doesn't exist in DB
    ...
    def to_dict(self):
        return {
            ...
            # 'user_preferences': self.user_preferences,  # Temporarily disabled
