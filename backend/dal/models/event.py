...
class Event(db.Model):
    ...
    # google_sync = db.Column(db.Boolean, default=True)  # Whether to sync with Google Calendar - TEMPORARILY DISABLED
    ...
    def to_dict(self):
        return {
            ...
            # 'google_sync': self.google_sync,  # TEMPORARILY DISABLED
