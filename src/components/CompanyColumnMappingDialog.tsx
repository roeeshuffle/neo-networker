...
interface CompanyColumnMappingDialogProps {
  open: boolean;
...
const DATABASE_COLUMNS = [
  ...
  { value: 'connection_strength', label: 'Connection Strength' },
  { value: 'twitter_follower_count', label: 'Twitter Follower Count' },
  { value: 'twitter', label: 'Twitter' },
  { value: 'domains', label: 'Domains' },
  { value: 'description', label: 'Description' },
  { value: 'notion_id', label: 'Notion ID' },
];

export const CompanyColumnMappingDialog = ({ open, onOpenChange, csvHeaders, onMappingComplete }: CompanyColumnMappingDialogProps) => {
